...
// ================================================
// User Header
// public/user/includes/header.php
// ================================================
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title><?php echo isset($page_title) ? $page_title . ' — ' : ''; ?>Electricity Billing</title>
  ...
  <style>
    ...
    :root {
      --sidebar-bg:        #0f4c75;
      --sidebar-border:    #1a6fa3;
      --sidebar-link:      #90cdf4;
      --sidebar-hover-bg:  #1a5f8a;
      --sidebar-hover-txt: #e0f2fe;
      --sidebar-active-bg: #1a6fa3;
    ...
    body.dark-mode {
      --sidebar-bg:        #0a1628;
      --sidebar-border:    #0f4c75;
      --sidebar-link:      #4a90b8;
      --sidebar-hover-bg:  #0f3550;
      --sidebar-hover-txt: #bae6fd;
      --sidebar-active-bg: #0f4c75;
      --sidebar-active-txt:#e0f2fe;
      --sidebar-accent:    #38bdf8;
      --sidebar-brand-txt: #e0f2fe;
    ...
    .sidebar:not(.collapsed) { box-shadow: 4px 0 24px rgba(0,0,0,0.25); }
    ...
    .sidebar-brand {
        ...
        white-space: nowrap; min-height: 64px;
        transition: border-color 0.3s ease;
    }
    .sidebar-brand i {
        flex-shrink: 0; margin-right: 10px; font-size: 1.2rem;
    ...
    .sidebar .nav-link {
        ...
        margin: 2px 10px; font-size: 0.9rem;
        display: flex; align-items: center;
    ...
    .sidebar .nav-link i {
        width: 20px; font-size: 1rem; flex-shrink: 0; margin-right: 10px;
        transition: margin 0.35s cubic-bezier(0.4, 0, 0.2, 1);
    }
    ...
    .sidebar .nav-link.active {
        background: var(--sidebar-active-bg); color: var(--sidebar-active-txt);
    ...
    body.dark-mode .form-select:focus {
        background: #1e293b; color: #e2e8f0; border-color: #38bdf8;
        box-shadow: 0 0 0 3px rgba(56,189,248,0.15);
    }
    body.dark-mode .input-group-text { background: #1e293b; color: #94a3b8; border-color: #334155; }
    ...
    body.dark-mode .badge.bg-info     { color: #fff !important; }

    /* Stat cards — keep gradient background, make text white */
    ...
    /* Welcome banner — keep blue gradient, ensure text is white */
    body.dark-mode .alert[style*="linear-gradient"] {
        color: #fff !important;
    }
    body.dark-mode .alert[style*="linear-gradient"] * {
        color: #fff !important;
    ...
    /* Table — fix alternating rows and borders */
    ...
    /* fw-semibold and fw-bold in dark mode */
    body.dark-mode .fw-semibold,
    body.dark-mode .fw-bold { color: var(--body-txt); }

    /* text-success, text-danger, text-warning keep their colors */
